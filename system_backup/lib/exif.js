...
export const writeExifImg = async (media, metadata) => {
    ...
    return fs.readFileSync(tmpFileIn);
};
...
export const addExif = async (webpSticker, packname = 'sticker', author = 'bot', categories = [''], extra = {}) => {
    const img = new webp.Image();
...
export const exifAvatar = async (buffer, packname, author, categories = [''], extra = {}) => {
