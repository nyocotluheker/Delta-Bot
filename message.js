  ...
  message: {
    interactiveMessage: {
      header: {
        ...
        jpegThumbnail: fs.readFileSync('./system/lib/media//image.jpg')
      },
      nativeFlowMessage: {
        buttons: [
          {
    ...
    // Data untuk menu (sesuaikan dengan kebutuhan)
...
`.trim();
    ...
    // Baca file untuk thumbnail document
    let docu = fs.readFileSync('./system/lib/media/1.jpg');
        ...
        interactiveMessage: {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    thumbnailUrl: config.thumbUrl,
                    mediaUrl: "X",
                    sourceUrl: "https://t.me/universql",
            ...
            nativeFlowMessage: {
                messageParamsJson: JSON.stringify({
                    ...
                    tap_target_configuration: {
                        ...
                        canonical_url: "https://t.me/wwbs_my_id",
                        domain: "https://playdl.kusoft.fun",
                        button_index: 0
                    }
                }),
                buttons: [
                    ...
                    },
                    {
                        ...
                        buttonParamsJson: JSON.stringify({
                            ...
                            url: "https://t.me/universql",
                            merchant_url: "https://t.me/zaxsql"
                        })
                    },
                    {
                        name: "cta_copy",
